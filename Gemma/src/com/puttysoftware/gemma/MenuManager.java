...
public class MenuManager {
    ...
    private JMenuItem fileOpenSavedGame, fileClose, fileSave, fileSaveAs, filePrint, filePreferences, fileExit;
    private JMenuItem gamePlay, gameEquipment, gameInventory, gameRegisterCharacter, gameUnregisterCharacter,
	    gameRemoveCharacter, gameEditNote, gameViewPrestige, gameViewScore, gameViewStats;
    ...
    private KeyStroke fileOpenSavedGameAccel, fileCloseAccel, fileSaveAccel, fileSaveAsAccel, filePrintAccel,
	...
	ArrayList<GenericEditor> allEditors = Gemma.getApplication().getAllEditors();
	...
	this.fileOpenSavedGameAccel = KeyStroke.getKeyStroke(KeyEvent.VK_O, modKey);
	...
	this.gameEditNoteAccel = KeyStroke.getKeyStroke(KeyEvent.VK_N, modKey | InputEvent.SHIFT_DOWN_MASK);
	...
	public void actionPerformed(final ActionEvent e) {
		...
		case "Remove Character...":
		    // Confirm
		    int confirm = CommonDialogs.showConfirmDialog("WARNING: This will DELETE the character from disk,\n"
			    + "and CANNOT be undone! Proceed anyway?", "Remove Character" + this.suffix);
