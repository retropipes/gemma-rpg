...
public class NameEditor extends GenericObjectEditor {
    ...
    public NameEditor() {
	super("Name Editor", Application.EDITOR_NAME, 2, 2, NamesConstants.NAMES_LENGTH, true);
	...
	if (nameLbl != null) {
	    ...
	    nameLbl.setText(" New " + NamesConstants.EDITOR_SECTION_ARRAY[num] + " Name: ");
	}
    }
	...
	this.cachedNames = Gemma.getApplication().getScenarioManager().getNamesFileManager().getNames();
    }

    @Override
    protected void saveObject() {
	Gemma.getApplication().getScenarioManager().getNamesFileManager().setNames(this.cachedNames);
    }

    @Override
    public void handleCloseWindow() {
	Gemma.getApplication().getScenarioManager().getNamesFileManager().saveNames();
	this.exitEditor();
    }
	...
	public void actionPerformed(final ActionEvent e) {
		...
		case "Edit Names":
			...
			me.create();
			Gemma.getApplication().getScenarioManager().getNamesFileManager().loadNames();
			me.reSetUpGUI();
			me.edit();
		    }
		    break;
