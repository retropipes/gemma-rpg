...
public abstract class GenericObjectEditor extends GenericEditor {
    ...
    protected GenericObjectEditor(final String newSource, final int editorID, final int actionCommandLength,
	    final int actionButtonRows, final int actionButtonCols, final boolean autoStoreEnabled) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		int num = Integer.parseInt(e.getActionCommand().substring(ge.actionCmdLen));
