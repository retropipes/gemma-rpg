...
class PreferencesGUIManager {
    ...
    private static final String[] battleSpeedChoiceArray = new String[] { "Very Slow", "Slow", "Moderate", "Fast",
	    "Very Fast" };
	...
	this.randomBattle.setSelected(LocalPreferencesManager.getRandomBattleEnvironment());
    }
	...
	LocalPreferencesManager.setRandomBattleEnvironment(this.randomBattle.isSelected());
	this.hidePrefs();
    }
	...
	mediaPane.setLayout(new GridLayout(PreferencesGUIManager.GRID_LENGTH, 1));
	for (int x = 0; x < PreferencesManager.MUSIC_LENGTH; x++) {
