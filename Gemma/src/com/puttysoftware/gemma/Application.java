...
public class Application {
    ...
    private Shop weapons, armor, healer, regenerator, items, enhancements, faiths;
	...
	this.getScenarioManager().getMap().addLevel(Support.getGameMapSize(), Support.getGameMapSize(),
		Support.getGameMapFloorSize());
	this.getScenarioManager().getMap().fillLevelRandomly(new Tile(), new Empty());
