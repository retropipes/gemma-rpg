...
class LogoCache {
    ...
    private final static int CACHE_INCREMENT = 5;
	...
	BufferedImageIcon[] tempCache = new BufferedImageIcon[LogoCache.cache.length + LogoCache.CACHE_INCREMENT];
	String[] tempNameCache = new String[LogoCache.cache.length + LogoCache.CACHE_INCREMENT];
