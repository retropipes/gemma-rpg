...
public class NamesDataManager {
	...
	try {
		...
		try (ResourceStreamReader rsr = new ResourceStreamReader(NamesDataManager.class
			.getResourceAsStream("/com/puttysoftware/gemma/support/resources/data/names/names.txt"))) {
		    return getDataInternal(rsr);
		}
	    }
    ...
    private static String[] getDataInternal(ResourceStreamReader rsr) throws IOException {
