 ...
 */
package com.puttysoftware.gemma.support.effects;
...
public class Effect {
    ...
    public void setSource(Creature newSource) {
	...
	if (hpEffect < 0) {
		...
		double dmgmult = target.getFaith().getMultiplierForOtherFaith(srcfid);
		double damage = hpEffect * dmgmult;
