...
public class PrestigeConstants {
    ...
    public static final String[] PRESTIGE_NAMES = new String[] { "Damage Given", "Damage Taken", "Hits Given",
	    "Hits Taken", "Attacks Dodged", "Missed Attacks", "Monsters Killed", "Spells Cast", "Times Killed",
	    "Times Ran Away" };
}
