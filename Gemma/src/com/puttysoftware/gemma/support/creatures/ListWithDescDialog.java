...
class ListWithDescDialog extends JDialog implements ActionListener {
    ...
    public static String showDialog(Component frameComp, Component locationComp, String labelText, String title,
	    String[] possibleValues, String initialValue, String descValue, String[] possibleDescriptions) {
	value = null;
	Frame frame = JOptionPane.getFrameForComponent(frameComp);
	dialog = new ListWithDescDialog(frame, locationComp, labelText, title, possibleValues, initialValue, descValue,
    ...
    private ListWithDescDialog(Frame frame, Component locationComp, String labelText, String title, String[] data,
	    String initialValue, String descValue, String[] possibleDescriptions) {
	...
	this.list.addListSelectionListener(new ListSelectionListener() {
		...
		descArea.setText(ListWithDescDialog.this.descs[ListWithDescDialog.this.list.getSelectedIndex()]);
	    }
	});
