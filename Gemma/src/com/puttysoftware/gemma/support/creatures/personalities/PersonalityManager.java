...
public class PersonalityManager {
	...
	dialogResult = PartyManager.showCreationDialog(owner, "Select a Personality", "Create Character", names,
	...
	if (!PersonalityManager.CACHE_CREATED) {
		...
		PersonalityManager.DESC_CACHE[x] = PersonalityManager.CACHE[x].getDescription();
	    }
