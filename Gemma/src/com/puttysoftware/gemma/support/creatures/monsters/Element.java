...
public class Element {
    ...
    public double getTransformRed() {
	return this.transformRed;
    }

    public double getTransformGreen() {
	return this.transformGreen;
    }

    public double getTransformBlue() {
	return this.transformBlue;
    }
