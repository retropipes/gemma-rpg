...
public class Water extends GenericField {
	...
	entry0.addActionArg(new InternalScriptEntryArgument(GameSoundConstants.SOUND_WATER));
	...
	entry1.addActionArg(new InternalScriptEntryArgument("Brrr, that water's COLD!"));
