...
public class Slime extends GenericField {
	...
	entry0.addActionArg(new InternalScriptEntryArgument(GameSoundConstants.SOUND_SLIME_HIT));
	...
	entry1.addActionArg(new InternalScriptEntryArgument("Ow, the slime ate into your flesh!"));
