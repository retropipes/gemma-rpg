...
public class Map implements MapConstants {
	...
	this.mapBasePath = Support.getScenario().getBasePath() + File.separator + "maps" + File.separator;
    }
	...
	Map temp = new Map();
	temp.addLevel(Support.getBattleMapSize(), Support.getBattleMapSize(), Support.getBattleMapFloorSize());
    ...
    public void fillLevelRandomly(final MapObject pass1FillBottom, final MapObject pass1FillTop) {
	this.mapData.fillRandomly(this, this.activeLevel, pass1FillBottom, pass1FillTop);
    }

    private void fillLevelRandomlyInBattle(final MapObject pass1FillBottom, final MapObject pass1FillTop) {
	this.mapData.fillRandomlyInBattle(this, this.activeLevel, pass1FillBottom, pass1FillTop);
    }
    ...
    private void readMapLevelX(XDataReader reader, int formatVersion) throws IOException {
	if (formatVersion == FormatConstants.SCENARIO_FORMAT_1) {
	    this.mapData = LayeredTower.readXLayeredTower(reader, formatVersion);
