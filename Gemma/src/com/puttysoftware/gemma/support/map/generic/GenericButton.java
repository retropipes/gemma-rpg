...
public abstract class GenericButton extends MapObject {
	...
	act0.addActionArg(new InternalScriptEntryArgument(this.offState.getName()));
	act0.addActionArg(new InternalScriptEntryArgument(this.onState.getName()));
	...
	act2.addActionArg(new InternalScriptEntryArgument(GameSoundConstants.SOUND_CA_CLICK));
