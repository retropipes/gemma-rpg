...
public class MapObjectList {
	...
	MapObject[] allDefaultObjects = { new Empty(), new Grass(), new Dirt(), new Sand(), new Snow(), new Tundra(),
		new Tile(), new Water(), new HotRock(), new Slime(), new Lava(), new Player(), new Wall(),
	...
	MapObject[] objs = this.getAllObjects();
	MapObject[] tempAllGroundLayerObjects = new MapObject[this.getAllObjects().length];
	int objectCount = 0;
    ...
    public MapObject readMapObjectX(XDataReader reader, int formatVersion) throws IOException {
	MapObject[] objs = this.getAllObjects();
	MapObject o = null;
	String UID = "";
