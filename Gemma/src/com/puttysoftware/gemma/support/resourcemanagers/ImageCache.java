...
class ImageCache {
    ...
    // Methods
    static BufferedImageIcon getCachedImage(final String name, final String rawName, final String cat,
	...
	if (!ImageCache.isInCache(cacheName)) {
	    BufferedImageIcon bii = ImageManager.getUncachedImage(name, cat, tt, horzflip, vertflip, helpImage);
