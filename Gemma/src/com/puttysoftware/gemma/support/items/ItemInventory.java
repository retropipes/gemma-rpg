...
public class ItemInventory {
    ...
    void equipOneHandedWeapon(Creature pc, Equipment ei, boolean useFirst, boolean playSound) {
    ...
    public static ItemInventory readItemInventory(XDataReader dr) throws IOException {
